create table "user" ("id" text not null primary key, "name" text not null, "email" text not null unique, "emailVerified" boolean not null, "image" text, "createdAt" timestamptz default CURRENT_TIMESTAMP not null, "updatedAt" timestamptz default CURRENT_TIMESTAMP not null, "role" text, "banned" boolean, "banReason" text, "banExpires" timestamptz, "isAnonymous" boolean, "phoneNumber" text unique, "phoneNumberVerified" boolean, "userMetadata" jsonb, "appMetadata" jsonb, "invitedAt" timestamptz, "lastSignInAt" timestamptz);
